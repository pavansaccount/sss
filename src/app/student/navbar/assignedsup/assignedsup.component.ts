...
declare var M: any;
@Component({
  selector: 'app-assignedsup',
  templateUrl: './assignedsup.component.html',
  styleUrls: ['./assignedsup.component.css']
})
export class AssignedsupComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.userService.getUserProfile().subscribe(
      res => {
        ...
        this.rollno = res['user'].assign[0].rollno;
